...
const checks = {
  ...
  decider_configured: decider.configured,
};
...
if (live && checks.decider_configured) {
  ...
  checks.decider_reachable = result.reason !== 'fallback';
}
console.log(JSON.stringify({ codex_home: codexHome, decider: decider.kind, checks }, null, 2));
