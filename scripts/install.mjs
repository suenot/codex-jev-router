...
const routingBlock = `${startMarker}\n## Subagent model routing\n\n` +
  ...
  `- For each justified Codex subagent spawn, run \`${command}\` with a short, sanitized task summary on stdin. Replace ROLE with the actual agent type. Skip routing only when the user explicitly chooses the subagent model.\n` +
